...
export const BADGES: BadgeSpec[] = [
  ...
  // ---- Learning — needs the lesson library --------------------------------
  {
    ...
    waitingOn: "Arrives with the lesson library.",
  },
  {
    key: "fifty_sunrises",
    name: "Fifty Sunrises",
  ...
  },
  {
    ...
    waitingOn: "Arrives once picks are counted separately from streak length.",
  },
  {
    key: "full_horizon",
    name: "Full Horizon",
    ...
    ring: "gold",
    status: "future",
    howToEarn: "Finish every lesson in a service track",
    detail: "A complete curriculum for one service, start to finish.",
    waitingOn: "Arrives with lesson tracks.",
  },
