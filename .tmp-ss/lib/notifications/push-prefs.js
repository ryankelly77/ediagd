...
exports.SECOND_ASK_STREAK = exports.DEFAULT_PUSH_PREF = void 0;
exports.shouldOfferSoftAsk = shouldOfferSoftAsk;
exports.loadPushPref = loadPushPref;
exports.hasLiveToken = hasLiveToken;
exports.DEFAULT_PUSH_PREF = {
 ...
 */
function shouldOfferSoftAsk(input) {
    ...
    if (pref.softAskAnswer === "yes")
        return false;
    /* The budget. Two, ever. */
    if (pref.softAskCount >= 2)
        return false;
