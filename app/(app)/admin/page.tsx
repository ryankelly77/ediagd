...
export default async function AdminPage({
  ...
  const moreHref = buildHref("/admin", {
    ...query,
    band: band ?? undefined,
    show: String(limit + LIST_PAGE_STEP),
  });
  const peopleMoreHref = buildHref("/admin", {
    ...query,
    band: band ?? undefined,
  ...
  return (
    <main className="mx-auto max-w-app px-4 pb-12 pt-5">
      ...
      {/* ---- 6. Tools ---------------------------------------------------- */}
      <h2 className="ediagd-eyebrow mt-8 px-1">Tools</h2>
      ...
      <div className="mt-2 grid gap-3 sm:grid-cols-2">
        ...
        <ToolCard
          ...
          hint="Confetti and reveal, without having to earn one."
        />
      </div>
    </main>
  );
